export const CONFIG = {
  ...
  pinHash: "b98241f882e040154e53a267781c98793d02c06f439fc5d91395e2d17592aa9b",               // sha256(pinSalt + PIN) hex — set in Task 11 with Meninder's PIN; also seeds the webhook token (sha256(pinSalt + PIN + ":webhook"), derived at unlock time)
  kids: [
